...
import static google.registry.monitoring.blackbox.TestUtils.assertHttpRequestEquivalent;
import static google.registry.monitoring.blackbox.TestUtils.assertHttpResponseEquivalent;
import static google.registry.monitoring.blackbox.TestUtils.makeHttpPostRequest;
...
public class WebWhoisModuleTest extends ProberModuleTest {

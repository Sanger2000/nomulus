...
public class MetricsCollectorTest {
  ...
  public void testSuccess_oneRecord() {
    ...
    assertThat(MetricsCollector.latencyMs)
        .hasDataSetForLabels(ImmutableSet.of(100), protocol, actionName, ResponseType.SUCCESS.name())
        .and()
        .hasNoOtherValues();
  }
  ...
  public void testSuccess_multipleRecords_same() {
    ...
    assertThat(MetricsCollector.responsesCounter)
        ...
        .hasNoOtherValues();
    assertThat(MetricsCollector.latencyMs)
        .hasDataSetForLabels(ImmutableSet.of(100, 200), protocol, actionName, ResponseType.FAILURE.name())
        .and()
        .hasNoOtherValues();
  }
  ...
  public void testSuccess_multipleRecords_differentStatus() {
    ...
    assertThat(MetricsCollector.latencyMs)
        .hasDataSetForLabels(ImmutableSet.of(100), protocol, actionName, ResponseType.SUCCESS.name())
        .and()
        .hasDataSetForLabels(ImmutableSet.of(200), protocol, actionName, ResponseType.FAILURE.name())
        .and()
        .hasNoOtherValues();
  }
}
